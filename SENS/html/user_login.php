...
$sql="SELECT *FROM customer WHERE uname='$username' AND upass = '$password'";
$result=mysqli_query($con,$sql);
$count=mysqli_num_rows($result);
if($count==1){
    header("refresh:1,url=user_page.php?user=$username");
}else{
...
<html>
	...
	color:#edf3ff;
	background:#c8c8c8;
	background:url('images/lg1.png') fixed;
  ...
  <div class="login-wrap" >
	<div class="login-html">
		...
		<div class="login-form">
            ...
            <form id=form1 action="registercheck.php" method="POST">
			<div class="for-pwd-htm" >
                ...
                <div class="group">
					...
					<input name="user_email" type="email" class="input">
                </div>
                <div class="group">
					<label for="user" class="label">Password</label>
					<input name="user_pass" type="password" class="input">
                </div>
                <div class="group">
					<label for="user" class="label">Confirm password</label>
					<input name="user_cpass" type="password" class="input">
                </div>
                <div class="group">
					<label for="user" class="label">mobile</label>
					<input name="user_mobile" type="number" class="input">
                </div>
				<div class="group">
